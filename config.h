...
static const char main_col[]            = "#383332";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_gray3, col_gray1, "#0f0e0d" },
...
static const char *dmenucmd[] = { "dmenu_run", "-wm", "-l", "15", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", "#756a5b", "-sf", col_gray4, NULL };
...
static Key keys[] = {
	...
	{ 0, XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer -c 0 -M set Master 2dB+") },
	{ 0, XF86XK_AudioLowerVolume,	spawn,		SHCMD("amixer -c 0 -M set Master 2dB-") },
